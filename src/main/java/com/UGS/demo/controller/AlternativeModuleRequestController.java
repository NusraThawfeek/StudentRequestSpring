...
import com.UGS.demo.service.AlternativeModuleRequestService;
...
public class AlternativeModuleRequestController {
	...
	public String submitAlternativeModuleRequest( @RequestParam String annex, @RequestParam String discontinueMcode[],
			@RequestParam String currentGrade[], @RequestParam String comment) {
		
		alterService.submitAlternativemoduleRequest(annex, discontinueMcode, currentGrade, comment);
	...
	@GetMapping("/request/alternativemodulerequest/{rid}")

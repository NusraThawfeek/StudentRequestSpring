...
import com.UGS.demo.repository.LeaveRequestRepository;
...
//	private StudentService studentService;
	...
	public LeaveRequest submitLeaveRequest(String leaveType, String purpose, Date from, Date to, int localWeeks, int localDays,
			int overseasWeeks, int overseasDays, int totalWeeks, int totalDays, int semesterWeeks, int semesterDays,
			int vacationWeeks, int vacationDays, String reason, String annex) {
//		
...
//    		
    		...
    		LeaveRequest req = new LeaveRequest(annex,enteredDate, "", false, leaveType, purpose, from, to, localWeeks, localDays,
			overseasWeeks, overseasDays, totalWeeks, totalDays, semesterWeeks, semesterDays,
			vacationWeeks, vacationDays, reason, "Leave");

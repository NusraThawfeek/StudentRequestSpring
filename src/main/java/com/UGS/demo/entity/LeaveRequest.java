...
public class LeaveRequest extends StudentReq {
	...
	public LeaveRequest(String annexPath, Date entereddatetime, String decision, boolean isSendToFacBoard,
			...
			int vacationWeeks, int vacationDays, String reason, String type) {
